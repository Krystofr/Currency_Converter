...
import app.christopher.currencyconverter.data.models.Rates
...
class MainViewModel @ViewModelInject constructor(
    ...
    sealed class CurrencyEvent {
        class Success(val resultTextView: String) : CurrencyEvent()
    ...
    fun convert(
        ...
        if (fromAmount == null) {
            _conversion.value = CurrencyEvent.Failure("That's Not a valid amount!")
            return
        }
